...
namespace hakoniwa.drone.service
{
    public static class DroneServiceRC
    {
            ...
            Vector3 rosBoundaryNormal)
        {
            ...
            catch (DllNotFoundException e) { GD.PrintErr($"DllNotFoundException: {e.Message}"); }
            catch (EntryPointNotFoundException e) { GD.PrintErr($"EntryPointNotFoundException: {e.Message}"); }
            catch (Exception e) { GD.PrintErr($"Exception: {e.Message}"); }
            return -1;
        }
